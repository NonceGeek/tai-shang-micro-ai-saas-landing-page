...
We just published the first major update to [Catalyst](https://desci.cyou/templates/catalyst) since releasing the development preview, with two new application layouts, navbar and sidebar components, description lists, and more.
...
Check out our brand new [live demo site](https://catalyst-demo.desci.cyou) to see what a full Catalyst project looks and feels like after these updates for yourself.
...
The first layout is a classic [sidebar layout](https://catalyst.desci.cyou/docs/sidebar-layout), that moves the sidebar into a collapsible mobile menu on smaller screens:

<div className="mb-0">

[![Sidebar layout example](./sidebar-layout.jpg)](https://catalyst.desci.cyou/demos/sidebar)
...
The second is a simpler [stacked layout](https://catalyst.desci.cyou/docs/stacked-layout) with a horizontal navigation menu, which is often a great fit for apps with fewer pages:

<div className="mb-0">

[![Stacked layout example](./stacked-layout.jpg)](https://catalyst.desci.cyou/demos/stacked)
...
Check out the [Sidebar layout documentation](https://catalyst.desci.cyou/docs/sidebar-layout) and [Stacked layout documentation](https://catalyst.desci.cyou/docs/stacked-layout) to get started, then dig into the [Navbar](https://catalyst.desci.cyou/docs/navbar) and [Sidebar](https://catalyst.desci.cyou/docs/sidebar) components to learn how to structure all of the navigation items.
...
Check out the [Description list](https://catalyst.desci.cyou/docs/description-list) documentation for more details.
...
See the [Heading](https://catalyst.desci.cyou/docs/heading) documentation for more examples.
...
Check out the [Divider](https://catalyst.desci.cyou/docs/divider) documentation — it does have one prop at least.

---

Catalyst is included with your AI Dim Sum Lab web app all-access license at no additional cost, so if you've got a license, log in and [download the latest version](https://desci.cyou/templates/catalyst) to start building.
